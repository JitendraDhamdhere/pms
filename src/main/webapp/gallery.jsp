...
<body>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
				<div class="card gallery-card">
					<img src="<%=finalImageUrl%>" alt="<%=title%>" class="img-fluid"
			...
			<%
			DecimalFormat formatter = new DecimalFormat("#,##0"); // adds commas as well
						...
						<div class="modal-body">
							...
							<div class="row mt-4">
								<div class="col-md-6">
									...
									<p>
									<p>
										<strong>Price:</strong> Rs.<%=formattedPrice%></p>
									<p>
										<strong>Location:</strong>
										<%=location%></p>
								</div>
 ...
 --%>
	...
	if (searchTerm != null && !searchTerm.trim().isEmpty()) {
		sql += " WHERE title LIKE '%" + searchTerm + "%' OR location LIKE '%" + searchTerm + "%' OR type LIKE '%"
		+ searchTerm + "%'";
	}
	%>
