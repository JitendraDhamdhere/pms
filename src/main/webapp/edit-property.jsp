...
<%
    ...
    if (!rs.next()) {
        response.sendRedirect("manage-properties.jsp?msg=notfound");
    }
    ...
    <form action="update-property.jsp" method="post">
        ...
        <div class="mb-3">
            ...
            <select name="type" class="form-select" required>
                ...
                <option value="Office" <%= type.equals("Office") ? "selected" : "" %>>Office</option>
        ...
        <div class="mb-3">
            <label>Price (₹)</label>
            <input type="number" name="price" class="form-control" value="<%= price %>" step="0.01" required>
        </div>
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="number" name="size" class="form-control" value="<%= size %>" required>
            </div>
            <div class="col">
                <label>Bedrooms</label>
                <input type="number" name="bedrooms" class="form-control" value="<%= bedrooms %>" required>
            </div>
            <div class="col">
                <label>Bathrooms</label>
                <input type="number" name="bathrooms" class="form-control" value="<%= bathrooms %>" required>
            </div>
        </div>
